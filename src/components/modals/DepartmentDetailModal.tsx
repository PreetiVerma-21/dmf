    ...
    >
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 border-b border-slate-100 pb-4">
          <div className="w-14 h-14 rounded-2xl bg-[#00796B]/15 text-[#00796B] flex items-center justify-center flex-shrink-0">
            {department.icon}
          </div>
          <div>
            <div className="flex items-center gap-3">
              ...
              <Badge count={`${department.servicesCount} Sanctioned Projects`} style={{ backgroundColor: '#00796B' }} />
            </div>
