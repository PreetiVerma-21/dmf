  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="hidden sm:flex flex-col items-end bg-[#1F2A44] border border-[#C6A75E]/60 rounded-xl px-4 py-2.5 text-right shadow-xl"
          >
            <div className="flex items-center gap-1.5 text-xs font-extrabold text-[#C6A75E] uppercase tracking-wider">
      ...
      >
        ...
        <div className="absolute -inset-4 sm:-inset-5 rounded-full border-2 border-dashed border-[#C6A75E] animate-[spin_12s_linear_infinite] shadow-[0_0_15px_rgba(198,167,94,0.6)] group-hover:border-[#E8DCC8] group-hover:shadow-[0_0_25px_rgba(232,220,200,0.9)] transition-all duration-300" />

        {/* 2. Counter-Clockwise Inner Glowing Dotted Ring */}
        <div className="absolute -inset-2 sm:-inset-2.5 rounded-full border-2 border-dotted border-[#E8DCC8] animate-[spin_8s_linear_infinite_reverse] shadow-[0_0_10px_rgba(232,220,200,0.5)]" />
        ...
        <svg 
          ...
          viewBox="0 0 100 100"
          style={{ filter: "drop-shadow(0 0 6px #C6A75E)" }}
        >
          <circle
            cx="50"
            cy="50"
          ...
          <defs>
            <linearGradient id="orbitGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="50%" stopColor="#E8DCC8" stopOpacity="0.9" />
              <stop offset="100%" stopColor="transparent" stopOpacity="0" />
            </linearGradient>
          </defs>
        </svg>

        {/* 4. Core Dynamic Circle with Theme Background (#1F2A44) & Glowing Border Ring */}
        <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full bg-[#1F2A44] border-3 border-[#C6A75E] group-hover:border-[#E8DCC8] flex items-center justify-center shadow-[0_0_20px_rgba(198,167,94,0.7)] group-hover:shadow-[0_0_35px_rgba(232,220,200,0.9)] transition-all duration-300">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative z-10 text-white group-hover:text-[#C6A75E] group-hover:scale-110 transition-all duration-300 drop-shadow-[0_0_8px_#C6A75E]"
            >
          ...
          <div className="absolute top-1 right-1 w-4 h-4 sm:w-5 sm:h-5 bg-[#C6A75E] border-2 border-[#1F2A44] rounded-full shadow-[0_0_8px_#C6A75E] flex items-center justify-center z-20">
