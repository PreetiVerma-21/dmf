  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="hidden sm:flex flex-col items-end bg-[#0B192C] border border-[#2DD4BF]/50 rounded-xl px-4 py-2.5 text-right shadow-xl"
          >
            <div className="flex items-center gap-1.5 text-xs font-extrabold text-[#2DD4BF] uppercase tracking-wider">
      ...
      >
        ...
        <div className="absolute -inset-4 sm:-inset-5 rounded-full border-2 border-dashed border-[#2DD4BF] animate-[spin_12s_linear_infinite] shadow-[0_0_15px_rgba(45,212,191,0.6)] group-hover:border-[#00F5D4] group-hover:shadow-[0_0_25px_rgba(0,245,212,0.9)] transition-all duration-300" />

        {/* 2. Counter-Clockwise Inner Glowing Dotted Ring */}
        <div className="absolute -inset-2 sm:-inset-2.5 rounded-full border-2 border-dotted border-[#00F5D4]/90 animate-[spin_8s_linear_infinite_reverse] shadow-[0_0_10px_rgba(0,245,212,0.5)]" />
        ...
        {/* 4. Core Dynamic Circle with Darker Theme Background (#081220) & Glowing Border Ring */}
        <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full bg-[#081220] border-3 border-[#2DD4BF] group-hover:border-[#00F5D4] flex items-center justify-center shadow-[0_0_20px_rgba(45,212,191,0.6)] group-hover:shadow-[0_0_35px_rgba(0,245,212,0.9)] transition-all duration-300">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative z-10 text-[#2DD4BF] group-hover:text-white group-hover:scale-110 transition-all duration-300 drop-shadow-[0_0_8px_#2DD4BF]"
            >
          ...
          <div className="absolute top-1 right-1 w-4 h-4 sm:w-5 sm:h-5 bg-[#00796B] border-2 border-[#0B192C] rounded-full shadow-[0_0_8px_#2DD4BF] flex items-center justify-center z-20">
